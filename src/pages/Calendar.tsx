...
export function CalendarView() {
  ...
  const startDate = startOfMonth(monthStart); // simplifies
  const endDate = endOfMonth(monthEnd);

  // Pad the dates to always show full weeks
    ...
    <div className="space-y-6 flex flex-col h-full bg-background rounded-xl pb-20">
      <div className="flex items-center justify-between mt-2">
        ...
        <div className="flex items-center gap-4 bg-card rounded-xl border p-1 shadow-sm">
          ...
          <span className="font-bold min-w-[120px] text-center capitalize">{format(currentDate, 'MMMM yyyy', { locale: tr })}</span>
